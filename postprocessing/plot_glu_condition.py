...
group_glu =[
	list( glu[i] for i in [3,6,9,12,15,18]),
...
fig.savefig(basename[0] + '_glutamate_condition' + '.png')

print("[plot_glu.py]:" + basename[0] + ".png created")
print(group_mean)
