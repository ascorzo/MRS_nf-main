...
glu = []
filename = 'ocd/ocd0748b_acc_m_6_glu.txt'
...
fig.savefig(basename[0] + '_glutamate_condition_box' + '.png')

print("[plot_glu.py]:" + basename[0] + "_glutamate_condition_box.png created")
